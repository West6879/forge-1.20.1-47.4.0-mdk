package net.west6879.firstmod.screen;
...
public class GemPolishingStationScreen extends AbstractContainerScreen<GemPolishingStationMenu> {
    ...
    private static final ResourceLocation TEXTURE = ResourceLocation.tryBuild(FirstMod.MODID, "textures/gui/gem_polishing_station_gui.png");
