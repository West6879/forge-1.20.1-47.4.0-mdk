package net.west6879.firstmod.sound;
...
public class ModSounds {
    ...
    private static RegistryObject<SoundEvent> registerSoundEvents(String name) {
        return SOUND_EVENTS.register(name, () -> SoundEvent.createVariableRangeEvent(ResourceLocation.tryBuild(FirstMod.MODID, name)));
    }
